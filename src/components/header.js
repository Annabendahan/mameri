...
<path d="M5 4L0.669823 0.5H9.33008L5 4Z" fill="#244C82"/>
          ...
          <span className="so sub-onglet">  <Link to="/indemnisation-des-victimes/" > DÉFENSE DES VICTIMES  <svg width="5" height="7" viewBox="0 0 5 10" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path d="M4.08008 4.74994L0.580078 9.08012L0.580078 0.419861L4.08008 4.74994Z" fill="white"/>
   ...
   <Link  to="/infractions-penales/" > <p className="m"> - INFRACTIONS PÉNALES </p>
   </Link>
