    ...
    <div className="background-hono">
      <div className="bigbox">
        <div className="bleft">
          ...
          <p className="desc">
            {" "}
            Votre employeur a commis des manquements graves dans l’exécution de
            votre contrat de travail rendant impossible le maintien de la
          ...
          <p className="desc">
            {" "}
            Maître Quentin MAMERI analysera votre dossier, vous conseillera
            utilement sur la procédure la plus adaptée au regard de votre
            situation, et assurera le défense de vos droits de salariés devant
