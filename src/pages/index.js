        ...
        <div className="indemn">
          <Link to="indemnisation-des-victimes">
            ...
            <p>
              ...
              œuvre pour vous permettre d’obtenir la réparation intégrale de vos
              préjudices.
            </p>
        ...
        <div className="salar">
          ...
          <Link to="defense-des-salaries">
            ...
            <p>
              ...
              rupture amiable de votre contrat de travail ? Votre employeur a
              commis des manquements graves dans l’exécution de de votre contrat
              de travail ? Vous souhaitez rompre votre contrat aux torts de
              l’employeur ? Maître Quentin MAMERI vous conseillera utilement et
              assurera la défense de vos intérêts tant par la voie amiable que
        ...
        <div className="ass">
          <Link to="defense-des-personnes-malades-handicap">
            ...
            <p>
              ...
              Départementale des Personnes handicapées (MDPH) ou votre compagnie
              d’assurance ? Maître Quentin MAMERI assurera la défense de vos
              intérêts à tous les stades de la procédure y compris pendant les
              éventuelles expertises médicales.
            </p>
            <div className="lire">
              {" "}
              <p>
