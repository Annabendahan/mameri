...
<div className="bigbox">
    ...
    <p className="desc"> Vous êtes victime d’agissements répétés de la part de votre employeur ou l’un de vos collègues qui ont pour objet ou pour effet de dégrader vos conditions de travail. </p>
<p className="desc"> Il s’agit alors d’un harcèlement moral qui constitue un manquement grave de l’employeur tant au regard des règles protectrices du droit du travail que de celles du droit pénal, le harcèlement moral étant constitutif d’un délit. </p>
