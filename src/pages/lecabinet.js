...
const LeCabinet = () => (
  ...
  <rect width="10" height="10" fill="#FFF509"/>
    ...
    <p className="desc"> Me Quentin MAMERI a suivi un <span className="bold"> cursus universitaire très spécialisé </span> qui lui a permis d’acquérir une solide expertise dans ses domaines d’intervention.

Il s’est forgé une véritable expérience au sein de cabinets d’avocat de victimes et à travers différents stages professionnels notamment au sein de chambres spécialisées de la Cour de cassation.
...
<Link to="/" className="button"> NOS DOMAINES D'EXPERTISES  <svg className="yellowr" width="14" height="8" viewBox="0 0 14 8" fill="none" xmlns="http://www.w3.org/2000/svg">
