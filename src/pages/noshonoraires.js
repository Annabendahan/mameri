...
<div className="background-hono">
  ...
  <div className="noshonoraires-box">
    ...
    <div className="noshonoraires-right">
      ...
      <rect width="10" height="10" fill="#FFF509"/>
        ...
        <p className="desc"> Dès le premier contact téléphonique, Me MAMERI procédera à une première évaluation de votre situation pour vérifier si votre affaire s’intègre bien dans le champ de compétence de son Cabinet et vous conviendrez ensemble d’un premier rendez-vous.
        Chaque affaire étant particulière, ce  premier rendez-vous est essentiel pour que Me MAMERI puisse vous rencontrer, prendre connaissance des pièces du dossier et vous proposer une stratégie personnalisée. La question des honoraires sera abordée sans aucun tabou et de manière totalement transparente. Il vous sera remis une convention d’honoraire détaillée qui vous permettra de savoir ce que cela va vous coûter. </p>
    </div>
  </div>
  ...
  <rect width="10" height="10" fill="#FFF509"/>
    ...
    L’honoraire fixe est établi en fonction de la procédure à engager, des difficultés de l’affaire et des diligences réalisées. Il est fixé de manière forfaitaire pour que vous puissiez prévoir à l’avance ce que cela va vous coûter. Ce n’est qu’exceptionnellement, en fonction des spécificités ou de la nature de l’affaire, que Me MAMERI pratiquera un honoraire au temps passé. Dans ce cas, il sera mentionné dans la convention d’honoraires le nombre prévisible d'heures nécessaires au traitement de votre affaire.
