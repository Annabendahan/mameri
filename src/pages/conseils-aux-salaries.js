          ...
          <div className="bigbox">
            <div className="bleft">
              ...
              <p className="desc">
                ...
                travail aux torts de l’employeur (prise d’acte de rupture ou
              ...
              <p className="desc">
                ...
                employeur. Les constatations du médecin du travail peuvent être
                très précieuses.{" "}
              </p>

              <p className="desc">
                Elles peuvent par exemple participer à la démonstration d’une
                situation de harcèlement moral. Sachez que vous bénéficier d’un
                droit d’obtenir directement la communication de votre dossier
                médical auprès de la médecine du travail. La demande se fait par
                courrier recommandé avec accusé de réception. Vous devez joindre
                à ce courrier une copie recto/verso de votre pièce d’identité.{" "}
              </p>
              ...
              <p className="desc">
                ...
                rupture au regard de votre situation. En effet, il arrive
                souvent qu’un salarié initie ou accepte une rupture
                ...
                envisagés comme par exemple la résiliation judiciaire ou la
              ...
              <p className="desc">
                ...
                votre situation. L’avocat pourra vous accompagner dans la
                démarche tendant à obtenir une rupture conventionnelle mais
              ...
              <p className="desc">
                ...
                en droit du travail et qui ont, pour beaucoup, été réduit depuis
              ...
              <p className="desc">
                {" "}
                A noter également que depuis la dernière réforme, le salarié
