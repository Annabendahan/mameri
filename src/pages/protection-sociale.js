...
class Protection extends  Component {
  ...
  render() {
    ...
    return(
     ...
     <div className="bigbox">
      <div className="bleft">
      <h1 className="title-spe"> PROTECTION SOCIALE </h1>
  ...
  <p className="desc"> <span className="bold"> L’invalidité est un statut accordé par la sécurité sociale à un salarié dont
  la capacité de travail est réduite des 2/3 suite à un accident ou une maladie sans
   caractère professionnel et qui lui donne droit notamment au versement d’une pension et
    à une prise en charge de ses frais de santé à 100 %. </span>  </p>

    <p className="desc">En effet, si la restriction de la capacité de
    travail fait suite à un accident du travail ou une maladie professionnelle,
    le salarié relève de la législation sur les risques professionnels et pourra
    bénéficier, en cas de consolidation avec séquelles, d’une rente ou d’un capital. </p>


     <p className="desc">Pour bénéficier d’un placement en invalidité, il faut réunir des conditions administratives (durée d’affiliation d’au moins 12 mois / durée de cotisation minimum) et médicales (restriction de la capacité de travail des 2/3 au moins). </p>
...
<p className="desc"> - <span className="bold"> Pension d’invalidité catégorie 3 : </span> Invalides qui, étant absolument incapables d'exercer une profession, sont, en outre, dans l'obligation d'avoir recours à l'assistance d'une tierce personne pour effectuer les actes ordinaires de la vie. </p>
 ...
 <h2 className="title"> <svg className="yellows" width="15" height="15" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
  <rect width="10" height="10" fill="#F2DC17"/>
   ...
   <h2 className="title"> <svg className="yellows" width="15" height="15" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
  <rect width="10" height="10" fill="#F2DC17"/>
  </svg> ARRÊT MALADIE </h2>


    <p className="desc"> <span className="bold">L’arrêt maladie permet à un salarié dans l’impossibilité de travailler de justifier son absence à son employeur et de bénéficier du versement d’indemnités journalières par la sécurité sociale pour compenser sa perte de revenu. </span> </p>
...
<h2 className="title"> <svg className="yellows" width="15" height="15" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <rect width="10" height="10" fill="#F2DC17"/>
    ...
    <p className="desc"> <span className="bold"> L’allocation aux adultes handicapés garantit un minimum de revenu aux personnes en situation de handicap ayant de faibles ressources et atteint d’un certain niveau d’incapacité. </span> </p>



      <p className="desc"> D’un point de vue médical, l’AAH est attribué :

- aux personnes atteintes d’un taux d’incapacité de 80 %
- aux personnes atteintes d’un taux d’incapacité compris entre 50 et 79 % et présentant une restriction substantielle et durable d’accès à l’emploi.

D’un point de vue administratif, pour bénéficier de l’AAH, il faut également résider en France de manière permanente et être âgé de 20 ans ou plus.

En cas de refus d’AAH pour des raisons médicales ou administratives, vous pouvez contacter Me Quentin MAMERI par téléphone, mail ou par le formulaire de contact afin d’évoquer votre situation et de convenir d’un rendez-vous. </p>
  ...
  <p className="desc">Il existe trois sortes de CMI :</p>
   ...
   <p className="desc"> - <span className="bold"> La CMI invalidité </span> permet d'obtenir une priorité d'accès aux places dans les transports en commun, dans les espaces et salles d'attente dans les établissements et les manifestations accueillant du public, et de bénéficier de certains avantages commerciaux.
...
Elle est attribuée aux personnes qui présentent un taux d'incapacité permanente d'au moins 80 %, ou qui sont en invalidité 3ème catégorie, ou pour les bénéficiaires de l’Allocation personnalisé d’autonomie (APA) classé en groupe 1 ou 2 de la grille Aggir. </p>
 ...
 <p className="desc"> - <span className="bold"> La CMI priorité </span> permet d'obtenir une priorité d'accès aux places dans les transports en commun, dans les espaces et salles d'attente dans les établissements et les manifestations accueillant du public.
...
<p className="desc"> En cas de refus de CMI pour des raisons médicales ou administratives, vous pouvez contacter Me Quentin MAMERI par téléphone, mail ou par le formulaire de contact afin d’évoquer votre situation et de convenir d’un rendez-vous.</p>
    ...
    <h2 className="title"> <svg className="yellows" width="15" height="15" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
  <rect width="10" height="10" fill="#F2DC17"/>
  </svg> RECONNAISSANCE DE QUALITÉ DE TRAVAILLEUR HANDICAPÉ</h2>
