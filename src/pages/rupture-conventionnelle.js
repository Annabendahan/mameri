    ...
    <div className="background-hono">
      <div className="bigbox">
        <div className="bleft">
          ...
          <p className="desc">
            Vous souhaitez rompre votre contrat de travail avec votre employeur
            d’un commun accord.
          </p>
          <p className="desc">
            Il est important de prendre contact avec un avocat préalablement à
            toute démarche. En effet, la conclusion d’une rupture
            conventionnelle suppose un consentement libre et éclairé de chaque
            partie.{" "}
          </p>
          <p className="desc">
            Cela implique que votre décision ne doit pas résulter de pressions
            de l’employeur ou être motivée par des manquements graves commis par
            l’employeur dans l’exécution du contrat de travail.
          </p>
          <p className="desc">
          ...
          <p className="desc">
            Par ailleurs, le rôle d’un avocat est également primordial dans le
            cadre d’une rupture conventionnelle pour défendre vos droits lors de
