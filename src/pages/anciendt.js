      ...
      <div className="bigbox">
        <div className="bleft">
          ...
          <p className="desc">
            ...
            <span className="bold">
              {" "}
              • Saisine du bureau de jugement du Conseil des Prud’hommes{" "}
            </span>{" "}
            afin de solliciter la requalification de cette rupture en
            licenciement aux torts de l’employeur.{" "}
          </p>

          <p className="desc">
            A l’issue de la procédure, plusieurs cas de figures peuvent se
            présenter :{" "}
          </p>

          <p className="desc">
            {" "}
            • Si le Conseil des Prud’homme considère que les manquements
          ...
          <p className="desc">
            {" "}
            • Dans le cas contraire, la prise d’acte sera requalifiée en
          ...
          <p className="desc" id="RJ">
            Eu égard aux risques inhérents à la prise d’acte, il est essentiel
            pour un salarié de prendre conseil auprès d’un avocat afin que
            celui-ci puisse le conseiller utilement sur l’opportunité d’une
            telle procédure et constituer un dossier solide et suffisamment
            étayé.{" "}
          </p>

          <p className="desc">
            Si vous envisagez un tel mode de rupture, vous pouvez contacter
          ...
          <p className="desc">
            ...
            intérêts. Si au contraire, le juge n’estime pas le(s) manquement(s)
            invoqué(s) suffisamment grave(s), le contrat n’est pas résilié et il
          ...
          <p className="desc" id="RC">
            {" "}
            Vous pouvez contacter Maître Quentin MAMERI, avocat de victime à
            Paris, par téléphone, mail ou par le formulaire de contact afin de
          ...
          <p className="desc" id="I">
            {" "}
            A l’issue de ce délai, l’employeur ou le salarié adressent la
            convention auprès de la Direccte pour homologation. La Direccte
            dispose d’un délai de 15 jours pour se prononcer. A défaut,
            l’homologation est acquise.
          </p>

          <p className="desc" id="I">
            Vous pouvez contacter Maitre Quentin MAMERI, par téléphone, mail ou
          ...
          <p className="desc">
            Si vous êtes victime de faits de harcèlement moral, vous pouvez
